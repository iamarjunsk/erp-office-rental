  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(properties), (property) => {
        _push(`<tr class="hover:bg-muted/50"><td class="px-4 py-3 text-sm font-medium">${ssrInterpolate(property.code)}</td><td class="px-4 py-3 text-sm">${ssrInterpolate(property.name)}</td><td class="px-4 py-3 text-sm"><span class="capitalize">${ssrInterpolate(property.type.replace("_", " "))}</span></td><td class="px-4 py-3 text-sm">${ssrInterpolate(property.city)}, ${ssrInterpolate(property.state)}</td><td class="px-4 py-3 text-sm">${ssrInterpolate(property.total_area?.toLocaleString())}</td><td class="px-4 py-3 text-sm"><span class="${ssrRenderClass([{
...
//# sourceMappingURL=index-CXDe97MX.js.map
