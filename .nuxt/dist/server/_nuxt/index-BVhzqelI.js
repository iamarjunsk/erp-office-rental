  ...
  async setup(__props) {
    ...
    const filteredVendors = computed(() => {
      return vendors.value.filter((v) => {
        const matchesSearch = !search.value || v.name?.toLowerCase().includes(search.value.toLowerCase()) || v.code?.toLowerCase().includes(search.value.toLowerCase());
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(filteredVendors), (vendor) => {
        ...
        _push(`<span class="capitalize">${ssrInterpolate(vendor.category?.replace("_", " "))}</span></div><div class="flex items-center gap-2 text-muted-foreground">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:map-pin",
          class: "w-4 h-4"
        }, null, _parent));
        _push(`<span>${ssrInterpolate(vendor.address?.city)}, ${ssrInterpolate(vendor.address?.state)}</span></div><div class="flex items-center gap-2 text-muted-foreground">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:user",
          class: "w-4 h-4"
        }, null, _parent));
        _push(`<span>${ssrInterpolate(vendor.contact?.name)}</span></div></div><div class="flex items-center justify-between pt-4 border-t border-border"><div class="flex items-center gap-1">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:star",
      ...
      if (unref(selectedVendor)) {
        ...
        _push(`<span>${ssrInterpolate(unref(selectedVendor).contact?.name)} (${ssrInterpolate(unref(selectedVendor).contact?.designation)})</span></div><div class="flex items-center gap-2">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:mail",
          class: "w-4 h-4 text-muted-foreground"
        }, null, _parent));
        _push(`<a${ssrRenderAttr("href", `mailto:${unref(selectedVendor).contact?.email}`)} class="text-primary hover:underline">${ssrInterpolate(unref(selectedVendor).contact?.email)}</a></div><div class="flex items-center gap-2">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:phone",
          class: "w-4 h-4 text-muted-foreground"
        }, null, _parent));
        _push(`<span>${ssrInterpolate(unref(selectedVendor).contact?.phone)}</span></div></div></div><div><h4 class="font-semibold mb-3">Address</h4><div class="text-sm text-muted-foreground">${ssrInterpolate(unref(selectedVendor).address?.street)}<br> ${ssrInterpolate(unref(selectedVendor).address?.city)}, ${ssrInterpolate(unref(selectedVendor).address?.state)} ${ssrInterpolate(unref(selectedVendor).address?.pincode)}<br> ${ssrInterpolate(unref(selectedVendor).address?.country)}</div></div><div><h4 class="font-semibold mb-3">Tax Information</h4><div class="grid md:grid-cols-2 gap-4 text-sm"><div><div class="text-muted-foreground">GST Number</div><div class="font-mono">${ssrInterpolate(unref(selectedVendor).gst_number)}</div></div><div><div class="text-muted-foreground">PAN Number</div><div class="font-mono">${ssrInterpolate(unref(selectedVendor).pan_number)}</div></div></div></div><div><h4 class="font-semibold mb-3">Performance</h4><div class="grid grid-cols-3 gap-4"><div class="bg-muted/50 p-4 rounded-lg text-center"><div class="flex items-center justify-center gap-1 mb-1">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:star",
...
//# sourceMappingURL=index-BVhzqelI.js.map
