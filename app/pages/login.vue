        ...
        <div class="w-full max-w-md mx-4">
            ...
            <div v-else class="bg-card border border-border rounded-2xl p-8 shadow-2xl">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <Input id="password" v-model="form.password"
                                :type="showPassword ? 'text' : 'password'" placeholder="••••••••" class="pl-10 pr-10"
                                required />
                ...
                <div class="space-y-2">
                    ...
                    <Button @click="loginAs('admin@officeerp.com', 'admin123')" variant="outline" class="w-full"
                        :disabled="isLoading">
                        <Icon v-if="isLoading && form.email === 'admin@officeerp.com'" name="lucide:loader-2"
                            class="w-4 h-4 mr-2 animate-spin" />
                        <Icon v-else name="lucide:shield" class="w-4 h-4 mr-2" />
                        Login as Admin
                    </Button>
                    <Button @click="loginAs('manager@officeerp.com', 'manager123')" variant="outline" class="w-full"
                        :disabled="isLoading">
                        <Icon v-if="isLoading && form.email === 'manager@officeerp.com'" name="lucide:loader-2"
                            class="w-4 h-4 mr-2 animate-spin" />
