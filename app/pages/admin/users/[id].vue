...
const saveUser = async () => {
    ...
    try {
        ...
        toast({ title: 'Error', description: String(e.data?.detail || 'Failed to update user'), variant: 'destructive' })
    } finally {
...
const deactivateUser = async () => {
    try {
        ...
        toast({ title: 'Error', description: String(e.data?.detail || 'Failed to deactivate user'), variant: 'destructive' })
    }
}
...
const activateUser = async () => {
    try {
        ...
        toast({ title: 'Error', description: String(e.data?.detail || 'Failed to activate user'), variant: 'destructive' })
    }
}
</script>
