                ...
                <form @submit.prevent="handleRegister" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="firstName" v-model="form.first_name" type="text" placeholder="John"
                        ...
                        <div>
                            ...
                            <input id="lastName" v-model="form.last_name" type="text" placeholder="Doe"
                                class="w-full px-4 py-3 bg-background border border-border rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent"
                                required />
                        </div>
                    </div>
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="passwordConfirm" class="block text-sm font-medium mb-2">Confirm Password</label>
                        <div class="relative">
                            <input id="passwordConfirm" v-model="form.password_confirm" :type="showPasswordConfirm ? 'text' : 'password'" placeholder="••••••••"
                                class="w-full pl-4 pr-12 py-3 bg-background border border-border rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent"
                                required />
