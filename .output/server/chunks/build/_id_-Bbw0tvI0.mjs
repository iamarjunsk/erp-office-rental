...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    watch(showReceiptModal, (isOpen) => {
      var _a;
      if (isOpen && ((_a = po.value) == null ? void 0 : _a.items)) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(po)) {
        ...
        _push(`</div></div><div class="grid lg:grid-cols-3 gap-6"><div class="lg:col-span-2 space-y-6"><div class="grid md:grid-cols-4 gap-4"><div class="bg-card border border-border rounded-xl p-4"><div class="text-sm text-muted-foreground">Subtotal</div><div class="text-xl font-bold">\u20B9${ssrInterpolate((_a = unref(po).subtotal) == null ? void 0 : _a.toLocaleString())}</div></div><div class="bg-card border border-border rounded-xl p-4"><div class="text-sm text-muted-foreground">Tax (${ssrInterpolate(unref(po).tax_rate)}%)</div><div class="text-xl font-bold">\u20B9${ssrInterpolate((_b = unref(po).tax_amount) == null ? void 0 : _b.toLocaleString())}</div></div><div class="bg-card border border-border rounded-xl p-4"><div class="text-sm text-muted-foreground">Shipping</div><div class="text-xl font-bold">\u20B9${ssrInterpolate((_c = unref(po).shipping_cost) == null ? void 0 : _c.toLocaleString())}</div></div><div class="bg-card border border-border rounded-xl p-4 bg-primary/5"><div class="text-sm text-muted-foreground">Total</div><div class="text-xl font-bold text-primary">\u20B9${ssrInterpolate((_d = unref(po).total_amount) == null ? void 0 : _d.toLocaleString())}</div></div></div><div class="bg-card border border-border rounded-xl overflow-hidden"><div class="p-4 border-b border-border"><h3 class="font-semibold">Order Items</h3></div><table class="w-full"><thead class="bg-muted/50"><tr><th class="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Item</th><th class="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Ordered</th><th class="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Received</th><th class="px-4 py-3 text-left text-xs font-medium text-muted-foreground uppercase">Unit Price</th><th class="px-4 py-3 text-right text-xs font-medium text-muted-foreground uppercase">Total</th></tr></thead><tbody class="divide-y divide-border"><!--[-->`);
        ssrRenderList(unref(po).items, (item) => {
          ...
          _push(`</div></td><td class="px-4 py-3">\u20B9${ssrInterpolate((_a2 = item.unit_price) == null ? void 0 : _a2.toLocaleString())}</td><td class="px-4 py-3 text-right font-medium">\u20B9${ssrInterpolate((_b2 = item.total_price) == null ? void 0 : _b2.toLocaleString())}</td></tr>`);
        });
        ...
        _push(`<!--]--></div></div></div><div class="space-y-6"><div class="bg-card border border-border rounded-xl p-6"><h3 class="font-semibold mb-4">Vendor</h3><div class="space-y-4"><div><div class="font-medium text-lg">${ssrInterpolate((_e = unref(po).vendor) == null ? void 0 : _e.name)}</div><div class="text-sm text-muted-foreground">${ssrInterpolate((_f = unref(po).vendor) == null ? void 0 : _f.address)}</div></div><div class="space-y-2 text-sm"><div class="flex items-center gap-2">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:user",
          class: "w-4 h-4 text-muted-foreground"
        }, null, _parent));
        _push(`<span>${ssrInterpolate((_h = (_g = unref(po).vendor) == null ? void 0 : _g.contact) == null ? void 0 : _h.name)}</span></div><div class="flex items-center gap-2">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:mail",
          class: "w-4 h-4 text-muted-foreground"
        }, null, _parent));
        _push(`<a${ssrRenderAttr("href", `mailto:${(_j = (_i = unref(po).vendor) == null ? void 0 : _i.contact) == null ? void 0 : _j.email}`)} class="text-primary hover:underline">${ssrInterpolate((_l = (_k = unref(po).vendor) == null ? void 0 : _k.contact) == null ? void 0 : _l.email)}</a></div><div class="flex items-center gap-2">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:phone",
          class: "w-4 h-4 text-muted-foreground"
        }, null, _parent));
        _push(`<span>${ssrInterpolate((_n = (_m = unref(po).vendor) == null ? void 0 : _m.contact) == null ? void 0 : _n.phone)}</span></div></div><div class="pt-2 border-t border-border text-sm"><div class="text-muted-foreground">GST Number</div><div class="font-mono">${ssrInterpolate((_o = unref(po).vendor) == null ? void 0 : _o.gstNumber)}</div></div></div></div><div class="bg-card border border-border rounded-xl p-6"><h3 class="font-semibold mb-4">Terms</h3><div class="space-y-3 text-sm"><div><div class="text-muted-foreground">Payment Terms</div><div>${ssrInterpolate(unref(po).terms)}</div></div>`);
...
//# sourceMappingURL=_id_-Bbw0tvI0.mjs.map
