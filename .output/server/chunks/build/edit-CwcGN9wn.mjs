...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1 class="text-3xl font-bold">Edit Property</h1><p class="text-muted-foreground">Update info for ${ssrInterpolate((_a = unref(property)) == null ? void 0 : _a.name)}</p></div></div>`);
      if (unref(formData)) {
...
//# sourceMappingURL=edit-CwcGN9wn.mjs.map
