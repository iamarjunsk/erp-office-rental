  ...
  async setup(__props) {
    ...
    watchEffect(() => {
      ...
      if (space.value) {
        ...
        amenitiesInput.value = ((_a = space.value.amenities) == null ? void 0 : _a.join(", ")) || "";
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1 class="text-3xl font-bold">Edit Space</h1><p class="text-muted-foreground">Update info for ${ssrInterpolate((_a = unref(space)) == null ? void 0 : _a.name)}</p></div></div>`);
      if (unref(formData)) {
...
//# sourceMappingURL=edit-DW9VW5wW.mjs.map
