  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(requests), (ticket) => {
        var _a, _b;
        _push(`<tr class="hover:bg-muted/50"><td class="px-4 py-3 text-sm font-medium">${ssrInterpolate(ticket.ticket_number)}</td><td class="px-4 py-3 text-sm">${ssrInterpolate(ticket.title)}</td><td class="px-4 py-3 text-sm">${ssrInterpolate((_a = ticket.property_details) == null ? void 0 : _a.name)}</td><td class="px-4 py-3 text-sm">${ssrInterpolate((_b = ticket.category_details) == null ? void 0 : _b.name)}</td><td class="px-4 py-3 text-sm"><span class="${ssrRenderClass([{
...
//# sourceMappingURL=index-Ba47qisv.mjs.map
