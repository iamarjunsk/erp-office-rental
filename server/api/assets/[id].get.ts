export default defineEventHandler((event) => {
    ...
    const assets: Record<string, any> = {
        1: {
            ...
            name: 'MacBook Pro 14"',
            description:
                "M3 Pro, 16GB RAM, 512GB SSD - Used for software development and design work",
        ...
        2: {
            ...
            description:
                "High-back mesh chair with lumbar support and adjustable armrests",
    ...
    const asset = assets[id as string];
    if (!asset) {
        return {
            id: Number(id),
