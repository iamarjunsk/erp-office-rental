...
class MaintenanceRequestViewSet(viewsets.ModelViewSet):
    ...
    def stats(self, request):
        ...
        # Optimized to use a single query instead of 7 distinct count queries
        ...
        stats = MaintenanceRequest.objects.aggregate(
            ...
            overdue=Count('pk', filter=Q(scheduled_date__lt=now_date, status__in=['open', 'assigned', 'in_progress'])),
        )
