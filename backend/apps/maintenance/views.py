...
class MaintenanceRequestViewSet(viewsets.ModelViewSet):
    ...
    def stats(self, request):
        ...
        # Optimize multiple count queries into a single database roundtrip using aggregation
        ...
        stats = MaintenanceRequest.objects.aggregate(
            ...
            overdue=Count('pk', filter=Q(scheduled_date__lt=timezone.now().date(), status__in=active_statuses))
        )
