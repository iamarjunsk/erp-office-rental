...
class PurchaseRequisitionViewSet(viewsets.ModelViewSet):
    ...
    """
    # ⚡ Bolt Optimization: Added 'converted_to_po' to select_related
    # Fixes N+1 queries from PurchaseRequisitionListSerializer.get_converted_to_po
    # Reduces query count from N+2 to 2 when listing requisitions
